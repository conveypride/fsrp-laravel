...
<head>
  ...
  -->
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/warning.css') }}"> 
    <script src="{{ asset('assets/js/warning.js') }}" type="module"></script>
...
<body>
 ...
 <div class="container my-2 py-2 text-center">
    <h4 class="fw-bold"> All Warning Subscription User List</h4>
    ...
    <table class=" table-responsive table table-striped table-bordered table-hover">
        ...
        <tbody>
            ...
            <td> {{ $warning->contact}}</td>
            <td>  {{ $warning->email}} </td>
            <td> {{ $warning->options}}</td>
          </tr>
